...
The `Commit Script` script uses the [MonkeyBreakSoftware](https://monkeybreaksoftware.de) plugin, it is not usable without a license.
MBS version requirement: `v10.1`
...
# Contact
For any questions or assistance, please [open an issue](https://github.com/deanayalon/fm-script-commit/issues). 
